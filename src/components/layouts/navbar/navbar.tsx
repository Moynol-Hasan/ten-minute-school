  ...
  return (
    <div className="mx-auto flex max-w-[1440px] items-center justify-between gap-3 px-4 py-3 md:px-7">
            ...
            >
              <div className="text-base">
                <Link
                  ...
                  href="/english-centre/"
                >
                  <p className="relative mb-0">ইংলিশ সেন্টার</p>
                  <svg
                    stroke="currentColor"
                    fill="none"
                    strokeWidth="2"
            ...
            >
              <div className="text-base">
                <Link
                  ...
                  href="#"
                >
                  <p className="relative mb-0">আরো</p>
                  <svg
                    stroke="currentColor"
                    fill="none"
                    strokeWidth="2"
      ...
      <div className="flex items-center space-x-4 md:space-x-6">
        <div className="flex items-center gap-3 max-h-96 md:gap-6">
          ...
          <span className="hidden cursor-pointer items-center gap-1 rounded border px-2 py-[2px] hover:bg-slate-50 md:flex rounded-md border-1">
            <svg
